...
Extended nscale ILM Connector Chart
...
```console
$ helm install my-release nplus/nplus-component-ilm
```
...
## nplus-component-ilm Chart Configuration

| Key | Description | Default |
|-----|-------------|---------|
image.name |  | `"ilm-connector"` |
image.repo |  | `"ceyoniq.azurecr.io/release/nscale"` |
image.tag |  | `"ubi.9.1.1100.2023102502"` |
