...
This is the argoCD Version of the sample tenant chart. It demonstrates the use of umbrella
...
```console
$ helm install my-release nplus/sample-tenant-argo
```
...
instance-argo.argocd.repo |  | `"https://helm.nplus.cloud"` |
instance-argo.argocd.selfHeal |  | `true` |
instance-argo.argocd.server |  | `"https://kubernetes.default.svc"` |
instance-argo.argocd.chart |  | `"nplus-instance"` |
instance-argo.argocd.namespace |  | `"argocd"` |
instance-argo.argocd.project |  | `"default"` |
instance-argo.argocd.prune |  | `true` |
instance-argo.argocd.repo |  | `"https://helm.nplus.cloud"` |
